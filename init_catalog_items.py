...
new_category = Category(name="Outdoors")
session.add(new_category)
session.commit()

new_category = Category(name="Video Games")
session.add(new_category)
session.commit()

new_category = Category(name="Technology")
session.add(new_category)
session.commit()

# Adding Basic Sub Categories
# Outdoors
new_sub_category = Sub_Category(name="Boots", cat_id=1)
session.add(new_sub_category)
session.commit()

new_sub_category = Sub_Category(name="Tents", cat_id=1)
session.add(new_sub_category)
session.commit()

new_sub_category = Sub_Category(name="Backpacks", cat_id=1)
session.add(new_sub_category)
session.commit()

# Video Games
new_sub_category = Sub_Category(name="Consoles", cat_id=2)
session.add(new_sub_category)
session.commit()

new_sub_category = Sub_Category(name="Games", cat_id=2)
session.add(new_sub_category)
session.commit()

new_sub_category = Sub_Category(name="Accessories", cat_id=2)
session.add(new_sub_category)
session.commit()

# Technology
new_sub_category = Sub_Category(name="Desktops", cat_id=3)
session.add(new_sub_category)
session.commit()

new_sub_category = Sub_Category(name="Laptops", cat_id=3)
session.add(new_sub_category)
session.commit()
